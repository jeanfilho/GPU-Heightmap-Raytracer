...
namespace CudaSpace
{
	__host__ void rayTrace(glm::ivec2& texture_resolution, glm::vec3& frame_dimensions, glm::vec3& camera_forward, glm::vec3& grid_camera_position, unsigned char* colorBuffer);
